...
namespace Mindforge.Editor
{
    ...
    public static class WorldV07Builder
    {
        ...
        public static void ApplyOpenScene()
        {
            ...
            // Local cell detail is attached to the annex so regenerating V0.6 topology and
            // rerunning V0.7 is deterministic and self-contained.
        ...
        private static NeuralGothicWorldArtAuditV07.ArtCounts CountArt(Transform root)
        {
            return new NeuralGothicWorldArtAuditV07.ArtCounts
            {
                renderers = root != null ? root.GetComponentsInChildren<Renderer>(true).Length : 0,
                lights = root != null ? root.GetComponentsInChildren<Light>(true).Length : 0,
                lines = root != null ? root.GetComponentsInChildren<LineRenderer>(true).Length : 0,
            };
        }
    ...
    /// quality, frame timing or coded neural stimulus behavior.
    /// </summary>
